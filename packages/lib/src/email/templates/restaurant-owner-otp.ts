export function getRestaurantOwnerOTPTemplate(
  otp: string,
  purpose: string = 'verification',
  expiryMinutes: number = 10
): string {
  const purposeText = purpose === 'signin' ? 'sign in to your restaurant dashboard' 
    : purpose === 'signup' ? 'complete your restaurant registration'
    : 'verify your account'
